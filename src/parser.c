...
enum ts_symbol_identifiers {
  ...
  aux_sym_fixed_width_token1 = 41,
  anon_sym_COLONPROPERTIES_COLON = 42,
  aux_sym_property_drawer_token1 = 43,
  anon_sym_COLONEND_COLON = 44,
  aux_sym_key_token1 = 45,
  anon_sym_COLONend_COLON = 46,
  sym_drawer_content = 47,
  sym_horizontal_rule = 48,
  aux_sym_paragraph_token1 = 49,
  aux_sym_paragraph_token2 = 50,
  sym_document = 51,
  sym__element = 52,
  sym_headline = 53,
  sym_title = 54,
  ...
  aux_sym_table_repeat1 = 76,
  aux_sym_table_row_repeat1 = 77,
  aux_sym_fixed_width_repeat1 = 78,
  aux_sym_property_drawer_repeat1 = 79,
  alias_sym_link_description = 80,
};
...
static bool ts_lex(TSLexer *lexer, TSStateId state) {
  ...
  switch (state) {
    ...
    case 21:
      ...
      if ((0x0b <= lookahead && lookahead <= '\r')) ADVANCE(186);
      if (lookahead != 0) ADVANCE(189);
      END_STATE();
    case 22:
      if (lookahead == '\n') ADVANCE(152);
    ...
    case 144:
      ...
      if ((0x0b <= lookahead && lookahead <= '\r')) ADVANCE(301);
      if (('0' <= lookahead && lookahead <= '9')) ADVANCE(87);
